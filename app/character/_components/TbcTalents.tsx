...
export const TbcTalents: React.FC<TalentProps> = (props) => {
        ...
        for (let j = 0; j < 4; j++) {
          ...
          if (talent) {
            const isSelected = talents[selectedSpec]?.talentTree
              ?.find((t) => t.name === n)
              ?.talents?.find((t) => t.id === talent.i || talent.s.includes(t.spellId));
            row.push(
              <Box
                border={
                  isSelected
              ...
              >
                <a
                  href={`https://www.wowhead.com/tbc/spell=${
...
async function loadTalentsFromJson(classType: number) {
  switch (classType) {
    case 1:
      return import("../../../json/tbc/warriorTalents.json");
    case 2:
      return import("../../../json/tbc/paladinTalents.json");
    case 3:
      return import("../../../json/tbc/hunterTalents.json");
    case 4:
      return import("../../../json/tbc/rogueTalents.json");
    case 5:
      return import("../../../json/tbc/preistTalents.json");
    case 7:
      return import("../../../json/tbc/shamanTalents.json");
    case 8:
      return import("../../../json/tbc/mageTalents.json");
    case 9:
      return import("../../../json/tbc/warlockTalents.json");
    case 11:
      return import("../../../json/tbc/druidTalents.json");
    default:
      return import("../../../json/tbc/warriorTalents.json");
  }
}
